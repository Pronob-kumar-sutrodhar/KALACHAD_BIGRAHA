...
const TRACKS_DATA = [
  {
    ...
    artistBn: 'মন্দির কীর্তন মণ্ডল',
    artistEn: 'Temple Kirtan Mandali',
    url: '/assets/audio/hare_krishna_kirtan.mp3',
  },
  {
    id: 2,
    titleBn: 'শ্রী শ্রী রাধাকৃষ্ণ মধুর বাঁশির সুর ও ধ্যান',
    titleEn: 'Krishna Flute Meditation (Bansuri Dhun)',
    artistBn: 'দিব্য বাঁশরী সেবা',
    artistEn: 'Divine Bansuri Seva',
  ...
  },
  {
    ...
    artistBn: 'শ্রী বৃন্দাবন সেবা ট্রাস্ট',
    artistEn: 'Vrindavan Seva Choir',
    url: '/assets/audio/achyutam_keshavam.mp3',
  },
  {
    id: 4,
    titleBn: 'রাধে রাধে গোবিন্দ রাধে বৈষ্ণব ভজন',
    titleEn: 'Radhe Radhe Govinda Radhe Bhajan',
    artistBn: 'বৈষ্ণব সেবা সঙ্ঘ',
    artistEn: 'Vaishnava Seva Sangha',
    url: '/assets/audio/radhe_govinda_bhajan.mp3',
  },
  {
    id: 5,
    titleBn: 'গোবিন্দ বলো হরি গোপাল বলো ভক্তিগীতি',
    titleEn: 'Govind Bolo Hari Gopal Bolo',
    artistBn: 'শ্রী ভক্তিসঙ্গীত মণ্ডল',
    artistEn: 'Bhakti Sangeet Choir',
    url: '/assets/audio/govind_bolo_hari_gopal.mp3',
  },
  {
    id: 6,
    titleBn: 'ওঁ নমো ভগবতে বাসুদেবায় স্তোত্র',
    titleEn: 'Om Namo Bhagavate Vasudevaya',
    artistBn: 'বৈদিক স্তোত্র পরিষদ',
    artistEn: 'Vedic Chanting Choir',
    url: '/assets/audio/om_namo_bhagavate.mp3',
  },
  {
    id: 7,
    titleBn: 'শ্রী শ্রী রাধাকৃষ্ণ নিত্য মঙ্গল আরতি স্তুতি',
    titleEn: 'Radha Krishna Mangala Aarti',
    artistBn: 'মন্দির প্রধান পূজারী পরিষদ',
    artistEn: 'Head Temple Priests',
